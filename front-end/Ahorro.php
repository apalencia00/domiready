...
if(cedula != "" && valor != ""){
    ...
    $.ajax({ url: "../back-end/Source/Ahorro.php", 
         ...
         dataType: 'json',
         data: { "oper" : 1, "id" : cedula, "valor" : valor, "fecha" : fecha  },
...
<div  class="form">
            ...
            <input class="buttom" name="submit" id="submit" tabindex="5" value="Agregar" type="button" onclick="addAhorroCentro()">  
