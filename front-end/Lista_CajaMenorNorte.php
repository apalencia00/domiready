...
$.ajax({ url: "../back-end/Source/Caja_Menor.php",
    contentType: "application/json",
         dataType: 'json',
         type: "GET", 
          data: { "oper" : 7  , "fecha_ini" : fecha_ini, "fecha_fin" : fecha_fin, "param" : tipo },
      ...
      $.each(jsonObj, function(key, value){
        ...
        html += '<tr> <td width="10%">' +  jsonObj[key].concepto + '</td>' + '<td width="10%">' +  jsonObj[key].detalle + '</td>' + '<td width="10%">' +  jsonObj[key].fecha_sys + '</td>' + '<td width="10%">' +  jsonObj[key].valor + '</td>' +  '<td width="10%">' +  jsonObj[key].saldo_caja_actual + '</td>' +'<td width="10%">' +  jsonObj[key].num_mob + '</td>' ;
        html += '</tr>';
...
<body onload="getConceptoCaja();" >
 ...
 <div class="container">
  <form id="form" name="form" method="post" class="form-horizontal">
    ...
    <h1>Listado Caja Menor Norte</h1>
