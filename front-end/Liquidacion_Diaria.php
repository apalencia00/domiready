...
var fliquidacion  = document.getElementById("fliquidar").value;
 ...
 $.ajax({ url: "../back-end/Source/Liquidar.php", 
         ...
         dataType: 'json',
         data: { "oper" : 1, "fk_empleado" : getselect_emp, "total" : total_mobil, "cantidad" : cantidad, "usuario" : usuario, "fliquidar" : fliquidacion }, 
  ...
  $.ajax({  url: "../back-end/Source/Parametrico_Empleado.php", 
            ...
            contentType: "application/json",
            dataType: 'json',
            data: { "oper" : 3, "num_mobil" : getselect_emp, "fliquida" : getfechaliquidar }, 
                ...
                if(json.root != null) {
                    ...
                    var res = json.success;                     
                                  ...
                                  if(res){
                                    ...
                                    //   console.log(jsonObj[key]);
                                            ...
                                            if(tipo_pago == 1 ) {
                                              ...
                                              tr = parseInt(tr) + (total * come/100); // 0 + (7000 * 30/100) tasa del movil real
                                              te = parseInt(te) + (total * comr/100); // 0 + (7000 * 70/100) tasa de la empresa
                        ...
                        //
                                ...
                                html += '<tr> <td width="15%">' +  jsonObj[key].n_des + '</td>' + '<td width="15%">' +  jsonObj[key].fecha_desp + '</td>' + '<td width="15%">'  + jsonObj[key].clienom + '</td>' + '<td width="15%">'  + jsonObj[key].dir_proc + '</td>'  + '<td width="15%">'  + jsonObj[key].dir_dest + '</td>'  + '<td width="15%">'  + jsonObj[key].tpago + '</td>' + '<td width="15%">'  + jsonObj[key].total + '</td>' + '<td width="15%">'  + jsonObj[key].descripcion + '</td>' ;
                                html += '</tr>';
