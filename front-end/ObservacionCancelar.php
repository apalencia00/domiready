...
function aceptar(){
	...
	var fecha = document.getElementById("fecha").value;
	 ...
	 $.ajax({ 
         ...
         dataType: 'json',
         data: {"oper": 16, "serv" : vserv, "fecha" : fecha, "usu" : vusu, "obs" : value, "estado" : 2 }, 

         success : function(json){

         	if (json[0].mensaje) {

         		document.getElementById("mensaje").innerHTML= "Orden Guardada como Cancelado";
...
<input type="hidden" readonly="" id="idser" name="idser" value="<?php echo $_GET['serv'] ?>" >
