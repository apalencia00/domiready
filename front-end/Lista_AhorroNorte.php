...
function buscarFechas(){
      ...
      $.ajax({ url: "../back-end/Source/Ahorro.php",
        ...
        dataType: 'json',
        type: "GET", 
        data: { "oper" : 4, "fecha_ini" : fecha_ini, "fecha_fin" : fecha_fin, "movil" : movil },
        ...
        console.log(jsonObj[key].num_servicio);
          html += '<tr> <td width="10%" >' + jsonObj[key].id_ahorro + '</td>' + '<td width="10%" align ="center">' +  jsonObj[key].fk_empleado + '</td>' + '<td width="10%" >' + jsonObj[key].num_mob + '</td>'   +'<td width="10%" align ="center" >' +  jsonObj[key].fecha_ahorro + '</td>'  + '<td width="10%" align ="center" >' +  jsonObj[key].valor + '</td>';
         html += '</tr>';
...
function totalAhorro(mob){
	...
	$.ajax({ url: "../back-end/Source/Parametrico.php", 
         ...
         contentType: "application/json",
         dataType: 'json',
            data: {"oper":23, "mobil" : mob },         
         success: function(json){
     			console.log("este es el total" + json);
...
$.ajax({ url: "../back-end/Source/Parametrico.php", 
  ...
  $.ajax({ url: "../back-end/Source/Empleado.php", 
      ...
      $.each(jsonObj, function(key, value){
         ...
         //
        html += '<tr> <td nowrap >' + jsonObj[key].id_ahorro + '</td>' + '<td width="200px" align ="center" nowrap>' +  jsonObj[key].fk_empleado + '</td>'   +'<td width="200px" align ="center" nowrap>' +  jsonObj[key].fecha_ahorro + '</td>' + '<td width="200px  align ="center"nowrap">' + '<td width="200px" align ="center" nowrap>' +  jsonObj[key].valor + '</td>';
        html += '</tr>';
...
<input class="btn btn-default" type="button" value="Buscar" onClick="buscarFechas();" />
  ...
  <tr>
    <td colspan="5">
      <div id="actualize" style="width: 950px; height: 200px; overflow-y: scroll;"  > </div></td>
  </tr>
