...
<head>
    ...
    <script src="front-end/bootstrap/js/bootstrap.min.js"></script>
</head>
</head>
<body>
...
<div class="container">
    <div class="row">
        <h1 class="text-center">Bienvenido Mandaos Express</h1>
      ...
      <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" align="center">
              <img class="img-circle" id="img_logo" src="front-end/images/pp.jpg">
